...
train_x_res, train_y_res = ros.fit_resample(train_x.numpy(), train_y.numpy())

# Convert oversampled data to tensors
train_x_res = torch.Tensor(train_x_res)
train_y_res = torch.Tensor(train_y_res).type(torch.LongTensor)

# DataLoader
train_dataset = torch.utils.data.TensorDataset(train_x_res, train_y_res)
